...
//echo "</tr>";
echo "<tr>";
echo "<h2><td>$name</td></h2>";
echo "<h2><td>$houseNumber</td></h2>";
echo "<h2><td>$assetDescription</td></h2>";
echo "<h2><td>$totalAsset</td></h2>";
	?> <h2><td><embed type="application/pdf" src="pdf/<?php echo $row['file'] ; ?>" width="200" height="200"></td></h2><?php
	echo"<td><input type='submit' value='confirm' name='con'>";
	echo"<input type='submit' value='Reject' name='rej'</td>";
echo "</tr>";
//echo "</tr>";
