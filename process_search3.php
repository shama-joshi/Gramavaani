...
<!-- The form -->
<form class="example" action="process_search3.php" >
...
$query1="SELECT * from complaintissue where housenumber='$hn' or firstname='$hn' or lastname='$hn' ";
$result=mysqli_query($conn,$query1);
	if(mysqli_num_rows($result)==0){
		echo"<script> alert('No results found..try again...')</script>";
			echo"<script>window.location.replace('issuefetch.php')</script>";
	}
		else{
echo "<table align='center' border='1px' style='width:700px;line-height:50px;'>";
	
echo "<tr>";
echo "<th colspan='5'><h2>complaint</h2></th>";
echo "</tr>";
echo "<tr>";
echo "<h2><th>firstname</th></h2>";
echo "<h2><th>lastname</th></h2>";
echo "<h2><th>housenumber</th></h2>";
echo "<h2><th>contact number</th></h2>";
echo "<h2><th>issues</th></h2>";
echo "</tr>";
...
echo "<h2><td>$contactNumber</td></h2>";
echo "<h2><td>$issueDescription</td></h2>";
echo "</tr>";
//echo "</tr>";
