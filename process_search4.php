...
$query1="SELECT * from villagerinfo where housenumber='$hn' or firstname='$hn' or lastname='$hn' or phonenumber='$hn' or adharnumber='$hn' or sex='$hn' ";
$result=mysqli_query($conn,$query1);
	if(mysqli_num_rows($result)==0){
		echo"<script> alert('No results found..try again...')</script>";
			echo"<script>window.location.replace('villagerinfofetch.php')</script>";
	}
		else{
